...
if("TRUE" STREQUAL "TRUE")
  set(open_karto_SOURCE_PREFIX /home/corvin/catkin_ws/src/open_karto)
  set(open_karto_DEVEL_PREFIX /home/corvin/catkin_ws/devel)
  ...
  set(open_karto_INSTALL_PREFIX /home/corvin/catkin_ws/install)
...
if(NOT "/home/corvin/catkin_ws/src/open_karto/include;/usr/local/include " STREQUAL " ")
  set(open_karto_INCLUDE_DIRS "")
  set(_include_dirs "/home/corvin/catkin_ws/src/open_karto/include;/usr/local/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'open_karto' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/corvin/catkin_ws/src/open_karto/${idir}'.  ${_report}")
    endif()
    _list_append_unique(open_karto_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "karto;/usr/local/lib/libboost_thread.so;-lpthread;/usr/local/lib/libboost_chrono.so;/usr/local/lib/libboost_system.so;/usr/local/lib/libboost_date_time.so;/usr/local/lib/libboost_atomic.so")
